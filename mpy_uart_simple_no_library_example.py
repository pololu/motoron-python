...
# serial interface using the machine.UART class in MicroPython, without
# using the Motoron library.
...
def set_speed(motor, speed):
  port.write(bytes([0xD1, motor, speed & 0x7F, (speed >> 7) & 0x7F]))
