...
# This example shows how to control the Motoron Motor Controller via serial
# if you want your system to just keep working, ignoring or automatically
# recovering from errors as much as possible.
#
...
#
# Errors reported by the underlying Python serial library are caught so they
