...
SERIAL_OPTION_7BIT_RESPONSES = 0
SERIAL_OPTION_14BIT_DEVICE_NUMBER = 1
SERIAL_OPTION_ERR_IS_DE = 2
...
SERIAL_ERROR_FLAG_FRAMING = 0
SERIAL_ERROR_FLAG_NOISE = 1
SERIAL_ERROR_FLAG_HARDWARE_OVERRUN = 2
SERIAL_ERROR_FLAG_SOFTWARE_OVERRUN = 3
